...
func (c *userClient) GetUserByUID(ctx context.Context, in *GetUserByUIDRequest, opts ...grpc.CallOption) (*GetUserByUIDReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.user.v1.User/GetUserByUID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*GetProfileReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.user.v1.User/GetProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_GetUserByUID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.User/GetUserByUID",
	}
...
func _User_GetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.User/GetProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
